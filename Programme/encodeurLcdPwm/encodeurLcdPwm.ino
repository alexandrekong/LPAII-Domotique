...
#define PIN_SDIN  13  // LCD SPIDat . Pin 6
#define PIN_SCLK  12  // LCD SPIClk . Pin 4
// LCD Gnd .... Pin 2
// LCD Vcc .... Pin 8
// LCD Vlcd ... Pin 7
#define MENU_0 0
...
void lireEtatEncodeur() {
  ...
  if (etatPinC != etatPinCAnterieur) {
    if (etatPinC == HIGH) {
      ...
      afficheMenu();
      if ((avance == true) && (recule == false)) {
        avancer();
         Serial.println("jesuiavance");
      } else if ((recule == true) && (avance == false)) {
        reculer();
         Serial.println("jesuirecule");
      }
...
void avancer() {
  ...
  analogWrite(pinPwm1, vitesse);
  digitalWrite(pinIN1,HIGH);
  digitalWrite(pinIN2,LOW);
  analogWrite(pinPwm2, vitesse);
...
void afficheMenu() {
  ...
  switch (etatMenu) {
    case MENU_0 :
      ...
      break;
    case MENU_1 :
      LcdString("vitesse 25%");
      vitesse = 64;
      break;
    case MENU_2 :
      LcdString("vitesse 50%");
      vitesse = 127;
      break;
    case MENU_3 :
      LcdString("vitesse 100%");
      vitesse = 255;
      break;
